...
const GlobalStyle = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .sig-toggle-bar { display:flex; align-items:center; gap:12px; margin-bottom:20px; padding:10px 16px; background:rgba(13,27,42,.04); border-radius:4px; flex-wrap:wrap; }
    .sig-toggle-label { font-size:.8rem; color:var(--muted); }
    .sig-toggle-btns { display:flex; background:#f0ede7; border-radius:20px; padding:2px; gap:2px; }
    .sig-btn { padding:5px 14px; border-radius:18px; border:none; cursor:pointer; font-size:.76rem; font-family:inherit; transition:.18s; background:transparent; color:var(--muted); }
    .sig-btn.active { background:var(--navy); color:var(--gold); }
    .sig-count { font-size:.72rem; color:var(--muted); margin-left:auto; }
...
function makeBill(f) {
  ...
  const parlUrl = f.parlUrl || (f.billId ? `https://bills.parliament.uk/bills/${f.billId}` : null);
  // significant: true = shown by default. false = hidden unless user clicks "Show all bills"
  // Criteria: bills that had major public debate, media coverage, or widespread impact
  const significant = f.significant !== false; // default true unless explicitly set false
  return { pubAyes:0, pubNoes:0, pubAbs:0, significant, ...f, parlUrl,
...
const BILLS = [
  makeBill({id:1,status:"live",year:2026,billId:7156,
  ...
  makeBill({id:2,status:"open",year:2026,billId:7049,
  ...
  makeBill({id:101,status:"closed",year:2020,billId:6561,
  ...
  makeBill({id:102,status:"closed",year:2020,billId:6378,
  ...
  makeBill({id:103,status:"closed",year:2022,billId:6640,
  ...
  makeBill({id:104,status:"closed",year:2023,billId:6809,
  ...
  makeBill({id:105,status:"closed",year:2022,billId:6654,
  ...
  makeBill({id:106,status:"closed",year:2023,billId:6858,
  ...
  makeBill({id:107,status:"closed",year:2023,billId:6831,
  ...
  makeBill({id:108,status:"closed",year:2022,billId:6732,
  ...
  makeBill({id:109,status:"closed",year:2023,billId:6834,
  ...
  makeBill({id:110,status:"closed",year:2024,billId:7060,
  ...
  makeBill({id:111,status:"closed",year:2024,billId:7068,
  ...
  // ── ADDITIONAL SIGNIFICANT BILLS 2020–2026 ────────────────────────────────

  // 2020
  makeBill({id:113,status:"closed",year:2020,
    title:"Immigration and Social Security Co-ordination (EU Withdrawal) Act 2020",category:"Immigration",
    chamber:"House of Commons",date:"11 Nov 2020",billId:6373,
    desc:"Ended free movement of EU citizens to the UK after Brexit, bringing EU citizens under the same immigration rules as everyone else.",
    impact:"Affected over 3 million EU citizens living in the UK and millions more who wished to move here.",
    plain:"After Brexit, EU citizens no longer had an automatic right to live and work in the UK. Everyone from the EU now has to apply for a visa, just like people from outside Europe always had to.",
    lifeTags:["worker","traveller","family","community"],
    question:"Was it right to end EU citizens\' free movement to the UK?",
    outcome:"The UK\'s points-based immigration system launched in January 2021. EU net migration fell initially but recovered by 2023.",
    ayes:342,noes:256,abs:0,parlOutcome:"passed"}),

  makeBill({id:114,status:"closed",year:2020,
    title:"Agriculture Act 2020",category:"Environment",
    chamber:"House of Commons",date:"11 Nov 2020",billId:6421,
    desc:"Reformed agricultural subsidies after Brexit, replacing EU Common Agricultural Policy payments with a new system rewarding environmental stewardship.",
    impact:"Affects 100,000 farm businesses in England; transition to new payments runs 2021–2027.",
    plain:"Farmers in England are moving away from EU-style payments based on how much land they own, to a new system that pays them for looking after nature — things like creating wildlife habitats, reducing flood risk, and improving soil quality.",
    lifeTags:["community","worker","homeowner"],
    question:"Should farmers be paid for protecting the environment rather than just for owning land?",
    outcome:"The Environmental Land Management scheme is rolling out. Many farmers have seen reduced income during transition. Food security concerns have grown.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:115,status:"closed",year:2020,
    title:"Overseas Operations (Service Personnel and Veterans) Act 2021",category:"Defence",
    chamber:"House of Commons",date:"28 Apr 2021",billId:6518,
    desc:"Created a five-year limit on prosecuting military personnel for alleged offences committed overseas, and required prosecutors to give extra weight to the impact on the armed forces.",
    impact:"Affects all UK military personnel and veterans involved in overseas operations.",
    plain:"Soldiers who served overseas — for example in Iraq or Afghanistan — are now harder to prosecute for alleged war crimes after five years have passed. The government said this would stop veterans being pursued by what it called \"vexatious\" claims. Critics said it put the UK above international law.",
    lifeTags:["community","worker"],
    question:"Should there be a time limit on prosecuting soldiers for alleged offences committed in war?",
    outcome:"Several prosecutions were dropped under the new rules. The law was criticised by the UN and human rights organisations.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  // 2021
  makeBill({id:116,status:"closed",year:2021,
    title:"Environment Act 2021",category:"Environment",
    chamber:"House of Commons",date:"9 Nov 2021",billId:6656,
    desc:"Set legally binding targets for air quality, biodiversity, water, and waste. Created a new independent Office for Environmental Protection to hold the government accountable.",
    impact:"First major environmental legislation since leaving the EU. Sets 2030 biodiversity targets.",
    plain:"This law set legal targets for cleaning up air, water and soil, and protecting wildlife. It also created a watchdog — the Office for Environmental Protection — to take the government to court if it breaks its own environmental promises.",
    lifeTags:["family","community","health"],
    question:"Should the government face legal consequences if it misses its environmental targets?",
    outcome:"The Office for Environmental Protection launched in 2022. Early reviews found the government was not on track for several targets. Air quality improvements have been slower than required.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:117,status:"closed",year:2021,
    title:"Nationality and Borders Act 2022",category:"Immigration",
    chamber:"House of Commons",date:"28 Apr 2022",billId:6646,
    desc:"Introduced a two-tier asylum system, criminalised arriving in the UK without prior permission, and increased maximum sentence for illegal entry to 4 years.",
    impact:"Fundamentally changed how asylum claims are processed in the UK.",
    plain:"People who arrived in the UK without permission — for example on a small boat — faced being treated as a second-class asylum seeker with fewer rights. Arriving without permission became a criminal offence. The government said this would make the system fairer. Critics said it was cruel and breached international law.",
    lifeTags:["community","worker"],
    question:"Should people be treated differently depending on how they arrived in the UK to claim asylum?",
    outcome:"The two-tier system was challenged in courts. The Rwanda plan that followed was found unlawful. Labour scrapped the Rwanda scheme in 2024.",
    ayes:298,noes:231,abs:0,parlOutcome:"passed"}),

  makeBill({id:118,status:"closed",year:2021,
    title:"Building Safety Act 2022",category:"Housing",
    chamber:"House of Commons",date:"28 Apr 2022",billId:6647,
    desc:"Overhauled building safety following the Grenfell Tower fire, created new duties on developers and building owners, and opened routes to compensation for leaseholders.",
    impact:"Affects 11 million people living in high-rise buildings. Developers face billions in remediation costs.",
    plain:"After the Grenfell Tower fire killed 72 people, this law forced developers and building owners to fix dangerous cladding and other safety issues at their own expense. If you live in a flat, your building management now has legal safety duties — and you have new rights to demand they fix problems.",
    lifeTags:["renter","homeowner","family","young"],
    question:"Should property developers be forced to pay for fixing unsafe buildings they built?",
    outcome:"Major developers signed remediation pledges worth billions. Many leaseholders are still waiting for cladding to be removed years later. The Building Safety Regulator began operating in 2023.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:119,status:"closed",year:2021,
    title:"Elections Act 2022",category:"Constitution",
    chamber:"House of Commons",date:"28 Apr 2022",billId:6694,
    desc:"Introduced mandatory photo ID to vote in elections, changed the rules on political donations, and reformed the Electoral Commission.",
    impact:"Roughly 2 million people who lacked accepted photo ID were required to obtain a free Voter Authority Certificate.",
    plain:"From 2023, you need to show photo ID to vote in a general or local election in England. Accepted forms include a passport, driving licence, or a free Voter Authority Certificate available from your council. Critics said this disenfranchised elderly, young and poorer voters.",
    lifeTags:["young","elderly","community"],
    question:"Should voters be required to show photo ID at polling stations?",
    outcome:"Around 14,000 people were turned away without voting at the 2023 local elections due to the new ID requirement. The Electoral Commission recommended reducing the minimum voting age, which the government rejected.",
    ayes:296,noes:234,abs:0,parlOutcome:"passed"}),

  // 2022
  makeBill({id:120,status:"closed",year:2022,
    title:"Schools Bill 2022 (SEND and AP Improvement Act 2023)",category:"Education",
    chamber:"House of Commons",date:"15 Nov 2023",billId:6856,
    desc:"Reformed the support system for children with special educational needs and disabilities (SEND), creating new national standards and local inclusion plans.",
    impact:"Affects 1.5 million children with Education, Health and Care Plans.",
    plain:"Children with special educational needs or disabilities will get support through a reformed system with clearer national standards. Local councils must produce \"inclusion plans\" for how they\'ll support SEND children in mainstream schools. Parents said the old system had too many battles to get children the help they needed.",
    lifeTags:["family","parent","young"],
    question:"Should the government be legally required to improve support for children with special needs?",
    outcome:"The SEND Improvement Plan launched in 2023. Many councils reported they were unable to fund the required provision. Tribunal cases for SEND support continued to rise.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:121,status:"closed",year:2022,
    title:"Northern Ireland Protocol Bill 2022",category:"Constitution",
    chamber:"House of Commons",date:"13 Sep 2023",billId:6748,
    desc:"Attempted to unilaterally override the Northern Ireland Protocol agreed with the EU after Brexit. Eventually replaced by the Windsor Framework negotiated with the EU.",
    impact:"Threatened to derail UK-EU trade relations and restart Irish border checks.",
    plain:"After Brexit, Northern Ireland stayed partly under EU rules to avoid a hard border with Ireland. The government decided it didn\'t like this arrangement and tried to pass a law ignoring it. This was legally controversial. Eventually the government and EU agreed a new deal — the Windsor Framework — so this Bill was dropped.",
    lifeTags:["business","worker","traveller"],
    question:"Was the government right to try to override the Northern Ireland Protocol it had agreed with the EU?",
    outcome:"The Bill was withdrawn in January 2023 after the UK and EU agreed the Windsor Framework, which replaced the Protocol.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:122,status:"closed",year:2022,
    title:"Strikes (Minimum Service Levels) Act 2023",category:"Welfare",
    chamber:"House of Commons",date:"20 Jul 2023",billId:6854,
    desc:"Gave ministers power to set minimum service levels during strikes in six key sectors including health, education, transport and border security.",
    impact:"Affects all workers in designated key sectors and limits their legal right to strike.",
    plain:"If you work in a hospital, school, train company or other key service and go on strike, your employer can now order you to come to work anyway to maintain a \"minimum service level\". If you refuse, you can be sacked. Trade unions called it an attack on the fundamental right to strike.",
    lifeTags:["worker","family","health"],
    question:"Should the government be able to order workers in essential services back to work during strikes?",
    outcome:"The Act was passed but enforcement was limited. Labour announced plans to repeal it in 2024 as part of the Workers\' Rights Act.",
    ayes:315,noes:246,abs:0,parlOutcome:"passed"}),

  // 2023
  makeBill({id:123,status:"closed",year:2023,
    title:"Renters Reform Bill 2023 (England)",category:"Housing",
    chamber:"House of Commons",date:"24 May 2024",billId:6866,
    desc:"The Conservative government\'s attempt to abolish Section 21 no-fault evictions — ultimately failed to pass before the 2024 election.",
    impact:"Would have affected 11 million private renters. Failed at the 2024 election dissolution.",
    plain:"The Conservative government promised to abolish no-fault evictions in 2019. This was the bill that was supposed to do it — but it kept being delayed, watered down and eventually ran out of time when the election was called. Labour\'s Renters\' Rights Bill is now attempting to do the same thing.",
    lifeTags:["renter","family","young"],
    question:"Should no-fault evictions have been abolished sooner?",
    outcome:"The Bill failed to complete all its parliamentary stages before the July 2024 general election. Labour introduced the Renters\' Rights Bill in 2024 to try again.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:124,status:"closed",year:2023,
    title:"Media Act 2024",category:"Digital",
    chamber:"House of Commons",date:"24 May 2024",billId:6960,
    desc:"Reformed public service broadcasting, relaxed ownership rules, overhauled the BBC and Channel 4\'s remits, and brought streaming platforms under Ofcom regulation.",
    impact:"Affects how the BBC, ITV, Channel 4 and streaming services like Netflix operate in the UK.",
    plain:"This law updated the rules for TV and streaming. Channel 4 was allowed to make its own programmes for the first time. The BBC and ITV got new rules about what they must show. Netflix and other streaming services now have to follow Ofcom\'s rules about what\'s on them.",
    lifeTags:["family","young","community"],
    question:"Should streaming services like Netflix be regulated in the same way as traditional TV?",
    outcome:"Ofcom began consulting on streaming regulation in 2024. Channel 4 launched its first in-house productions. BBC Charter renewal discussions began.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:125,status:"closed",year:2023,
    title:"Criminal Justice Bill 2024",category:"Justice",
    chamber:"House of Commons",date:"24 May 2024",billId:6953,
    desc:"Wide-ranging criminal justice reforms — but the Bill failed to complete all its stages before the 2024 election was called.",
    impact:"Would have introduced new knife crime powers, changes to probation and new stalking protections.",
    plain:"The Conservative government\'s final criminal justice bill was dropped when the election was called. It included new powers to confiscate knives, reforms to the probation system and stronger protections for stalking victims. Because it didn\'t finish in time, none of it became law.",
    lifeTags:["community","family","young"],
    question:"Should knife crime carry automatically tougher sentences?",
    outcome:"The Bill fell at dissolution of Parliament in May 2024. The Labour government introduced separate knife crime legislation in 2025.",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  // 2024 onwards
  makeBill({id:126,status:"closed",year:2024,
    title:"Crime and Policing Bill 2024",category:"Justice",
    chamber:"House of Commons",date:"Feb 2025",billId:7088,
    desc:"Labour\'s flagship crime legislation — introduced new knife crime offences, reformed police misconduct procedures, and created new powers to tackle antisocial behaviour.",
    impact:"New offence of possessing a bladed article with intent to injure. Police accountability reforms.",
    plain:"A wide-ranging law on crime. It made carrying a knife with intent to use it on someone a specific new crime with tougher sentences. It also reformed how complaints about police are investigated, giving victims more rights. New powers for councils and police to tackle antisocial behaviour.",
    lifeTags:["community","family","young"],
    question:"Should knife crime carry tougher mandatory sentences?",
    ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:127,status:"open",year:2025,
    title:"Planning and Infrastructure Bill 2025",category:"Housing",
    chamber:"House of Commons",date:"Mar 2025",billId:7108,
    desc:"Labour\'s major planning reform — speeds up planning decisions, reduces local veto power over development, and sets binding housing targets for all councils.",
    impact:"Target of 1.5 million new homes by 2029. Councils that miss targets face sanctions.",
    plain:"This law makes it easier and faster to build new homes, roads and energy infrastructure. Local councils have less power to block new housing. Every council has a legal target for how many homes must be built, and if they miss it they face consequences. Supporters say the housing crisis demands this. Critics say it destroys local democracy.",
    lifeTags:["renter","homeowner","family","young"],
    question:"Should local communities have less say over new housing development in their area?",
    ayes:0,noes:0,abs:0}),

  makeBill({id:128,status:"open",year:2026,
    title:"Data (Use and Access) Bill 2025",category:"Digital",
    chamber:"House of Commons",date:"Oct 2024",billId:7047,
    desc:"Reforms how personal data is used in the UK, replacing elements of UK GDPR with a new framework, and enabling greater data sharing between public bodies.",
    impact:"Affects every organisation that processes personal data in the UK.",
    plain:"This updates the UK\'s data protection rules after Brexit. It\'s meant to make it easier for companies and government bodies to share data — which supporters say will improve public services and cut red tape. Critics worry it weakens your privacy rights and your control over your own personal information.",
    lifeTags:["worker","business","young","family"],
    question:"Should companies find it easier to use your personal data if it improves services?",
    ayes:0,noes:0,abs:0}),

  makeBill({id:129,status:"open",year:2026,
    title:"Border Security, Asylum and Immigration Bill 2025",category:"Immigration",
    chamber:"House of Commons",date:"Dec 2024",billId:7077,
    desc:"Labour\'s flagship immigration legislation — created a new Border Security Command, introduced new offences for people smugglers, and reformed the asylum system.",
    impact:"Aims to smash people smuggling gangs. New fast-track removal powers.",
    plain:"Labour\'s answer to small boat crossings. A new Border Security Command was set up to go after the criminal gangs who organise dangerous Channel crossings. New laws make it easier to prosecute people smugglers and faster to remove people who have no right to be here. Critics from the left said it was too harsh; critics from the right said it wouldn\'t stop the boats.",
    lifeTags:["community","worker"],
    question:"Should people smugglers face tougher sentences and new criminal charges?",
    ayes:0,noes:0,abs:0}),

  makeBill({id:130,status:"open",year:2026,
    title:"Equality (Race and Disability) Bill 2025",category:"Welfare",
    chamber:"House of Commons",date:"Jan 2025",
    desc:"Proposed mandatory ethnicity and disability pay gap reporting for large employers, and strengthened protections against discrimination.",
    impact:"Would affect all employers with 250+ employees — around 10,000 organisations.",
    plain:"Large companies would have to publish data showing whether they pay white employees more than Black, Asian or minority ethnic employees, and whether disabled workers are paid less. The idea is that making the gap public creates pressure to close it. Opponents said it created unnecessary bureaucracy.",
    lifeTags:["worker","community","young"],
    question:"Should large companies be legally required to publish their ethnicity and disability pay gaps?",
    ayes:0,noes:0,abs:0}),

  // ══════════════════════════════════════════════════════════════════════════
  // ALL GOVERNMENT BILLS — 2024-26 SESSION (King's Speech + additional)
  // significant:true = shown by default; significant:false = hidden unless 
  // user clicks "Show all government bills"
  // ══════════════════════════════════════════════════════════════════════════

  // ── SIGNIFICANT government bills (widely debated, major public impact) ───
  makeBill({id:200,status:"closed",year:2025,
    title:"Employment Rights Act 2025",category:"Welfare",
    chamber:"House of Commons",date:"10 Oct 2024",billId:3737,
    desc:"The full Employment Rights Bill — day-one unfair dismissal rights, banned zero-hours contracts, strengthened trade union rights, and right to flexible working from day one.",
    impact:"The biggest upgrade to workers\' rights in a generation. Affects all 28 million UK workers.",
    plain:"From day one of any new job, you now have the right not to be unfairly dismissed. Zero-hours contracts that leave you available but guarantee no work are banned unless you want one. You have the right to request flexible working from your first day. Trade unions can organise more easily.",
    lifeTags:["worker","young","family"],
    question:"Did workers deserve stronger employment rights from day one of a new job?",
    outcome:"The Act gained Royal Assent in July 2025. Unions reported increased membership. Some businesses warned of reduced hiring flexibility.",
    significant:true,ayes:347,noes:234,abs:0,parlOutcome:"passed"}),

  makeBill({id:201,status:"closed",year:2025,
    title:"Tobacco and Vapes Act 2026",category:"Health",
    chamber:"House of Commons",date:"5 Nov 2024",billId:3751,
    desc:"Banned the sale of tobacco products to anyone born after 1 January 2009, creating a generational ban on smoking. Extended regulations to vapes and nicotine products.",
    impact:"Anyone born after 1 Jan 2009 will never legally be able to buy cigarettes — the first country in the world to do this.",
    plain:"If you were born after 1 January 2009, you will never be legally able to buy cigarettes in the UK — no matter how old you get. This is a \"generational ban\". Vapes are also more tightly regulated. Supporters say it will prevent 250,000 young people from taking up smoking. Critics called it a nanny state measure.",
    lifeTags:["health","young","family"],
    question:"Should the government permanently ban cigarette sales to people born after 2009?",
    outcome:"Royal Assent received 29 April 2026. The ban on tobacco sales comes into force 1 January 2027.",
    significant:true,ayes:383,noes:67,abs:0,parlOutcome:"passed"}),

  makeBill({id:202,status:"closed",year:2025,
    title:"Crime and Policing Act 2026",category:"Justice",
    chamber:"House of Commons",date:"12 Sep 2024",billId:3765,
    desc:"Martyn's Law — mandatory security requirements for public venues. New knife crime offences. Police accountability reforms. Anti-social behaviour powers.",
    impact:"Named after Martyn Hett, killed in the Manchester Arena bombing. Affects all large public venues.",
    plain:"Large venues like stadiums and concert halls must now have proper security plans and staff training to protect people from terror attacks. It also created a new specific offence for assaulting shop workers, and gave police new powers to tackle antisocial behaviour.",
    lifeTags:["community","family","worker"],
    question:"Should large venues like concert halls be legally required to have anti-terror security plans?",
    outcome:"Royal Assent 29 April 2026. Martyn's Law provisions took effect immediately for larger venues.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:203,status:"closed",year:2025,
    title:"Great British Railways (Transfer of Undertakings) Act 2025",category:"Transport",
    chamber:"House of Commons",date:"1 May 2025",billId:3777,
    desc:"Enabled the government to bring rail franchises back into public ownership as contracts expire, creating Great British Railways as a single national operator.",
    impact:"Returns rail to public ownership for the first time since privatisation in the 1990s.",
    plain:"Train companies\' contracts are being allowed to expire and trains are returning to public ownership one by one. Great British Railways will eventually run the whole network. Supporters say this will end the fragmented, expensive system. Critics warn of bureaucracy and higher costs.",
    lifeTags:["worker","traveller","community"],
    question:"Should the railways be publicly owned and run as a single national service?",
    outcome:"First rail franchises transferred to public ownership in 2025. Great British Railways body established.",
    significant:true,ayes:313,noes:235,abs:0,parlOutcome:"passed"}),

  makeBill({id:204,status:"closed",year:2025,
    title:"Terrorism (Protection of Premises) Act 2025",category:"Justice",
    chamber:"House of Commons",date:"12 Sep 2024",billId:3765,
    desc:"Required venues with 200+ capacity to have basic security plans, and venues with 800+ to have more comprehensive protections including security staff.",
    impact:"Affects 24,000 large venues and 650,000 smaller venues across the UK.",
    plain:"After the Manchester Arena attack that killed 22 people including Martyn Hett, this law forces concert venues, stadiums and other public places to have proper security procedures. Smaller venues get lighter-touch rules; larger ones need trained staff and detailed emergency plans.",
    lifeTags:["community","family"],
    question:"Was Martyn's Law the right response to the Manchester Arena attack?",
    outcome:"Part of the Crime and Policing Act 2026. Venues must comply by 2027.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:205,status:"closed",year:2025,
    title:"Children's Wellbeing and Schools Act 2025",category:"Education",
    chamber:"House of Commons",date:"8 May 2025",billId:3860,
    desc:"Introduced breakfast clubs in every primary school, required all new teachers to have qualified teacher status, and strengthened children's social care.",
    impact:"Universal breakfast clubs in all 17,000 primary schools. Affects 4 million primary-age children.",
    plain:"Every primary school must now offer a breakfast club. Schools must tell councils if a child stops attending without explanation. Care leavers get more support until they\'re 25. New teachers must have proper qualified teacher status — ending a controversial policy of allowing unqualified teachers in academies.",
    lifeTags:["family","parent","young"],
    question:"Should every primary school be legally required to offer a breakfast club?",
    outcome:"Universal breakfast clubs to roll out from September 2025. Some schools reported funding concerns.",
    significant:true,ayes:318,noes:202,abs:0,parlOutcome:"passed"}),

  makeBill({id:206,status:"closed",year:2025,
    title:"Leasehold and Commonhold Reform Act 2025",category:"Housing",
    chamber:"House of Commons",date:"Nov 2024",billId:3852,
    desc:"Dramatically reformed leasehold law — made it easier and cheaper for leaseholders to buy their freehold or extend their lease, and created a new commonhold system.",
    impact:"Affects 5 million leaseholders in England and Wales who own flats or houses on a leasehold basis.",
    plain:"If you own a leasehold flat, this law made it much cheaper and simpler to buy the freehold from your landlord or extend your lease. Ground rents have been banned for new leases. A new \"commonhold\" system lets flat owners collectively own the building together rather than through a landlord.",
    lifeTags:["homeowner","young","family"],
    question:"Were leaseholders being exploited by the old leasehold system, and did it need to change?",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:207,status:"open",year:2026,
    title:"Cyber Security and Resilience Bill",category:"Digital",
    chamber:"House of Commons",date:"2025",billId:3872,
    desc:"Extended cybersecurity reporting obligations to more organisations and sectors, particularly digital service providers and supply chains.",
    impact:"Extends mandatory cyber incident reporting to thousands more UK organisations.",
    plain:"More companies — especially technology and digital service providers — will have to report significant cyber attacks to the government. The idea is to build a better national picture of cyber threats and force companies to take security more seriously.",
    lifeTags:["worker","business","community"],
    question:"Should more companies be legally required to report cyber attacks to the government?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:208,status:"open",year:2026,
    title:"Representation of the People Bill",category:"Constitution",
    chamber:"House of Commons",date:"Feb 2026",
    desc:"Votes at 16 — lowers the voting age to 16 for all UK parliamentary and local elections. Also includes reforms to tackle AI-generated disinformation in elections.",
    impact:"Would give the vote to around 1.5 million 16 and 17-year-olds.",
    plain:"16 and 17-year-olds would get the right to vote in general elections and local elections across England — already the case in Scotland and Wales. The Bill also adds new rules about AI-generated fake content used in election campaigns.",
    lifeTags:["young","community"],
    question:"Should 16-year-olds be allowed to vote in general elections?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:209,status:"open",year:2026,
    title:"High Speed Rail (Crewe–Manchester) Bill",category:"Transport",
    chamber:"House of Commons",date:"2025",
    desc:"Hybrid Bill authorising the construction of the HS2 extension from Crewe to Manchester, giving legal powers to acquire land and begin construction.",
    impact:"£10–15bn project. Reduces journey time from Manchester to London to under 1 hour 30 minutes.",
    plain:"This gives the government legal power to buy land and start building the HS2 railway extension from Crewe to Manchester. It\'s a major infrastructure project that supporters say will transform transport in the North. Critics question the cost and whether it\'s worth it when local rail services are struggling.",
    lifeTags:["worker","traveller","community"],
    question:"Should the government continue with the HS2 extension from Crewe to Manchester?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:210,status:"open",year:2026,
    title:"Railways Bill",category:"Transport",
    chamber:"House of Commons",date:"2025",billId:3815,
    desc:"The main legislative vehicle for rail nationalisation — establishing Great British Railways as a statutory body and setting the long-term framework for the publicly-owned railway.",
    impact:"Full nationalisation of passenger rail services. Structural reform of the whole rail industry.",
    plain:"This is the main law creating Great British Railways — a single organisation to run all passenger trains. It sets out how the new body will be governed, how it will work with devolved governments, and how the transition from private franchises will work over coming years.",
    lifeTags:["worker","traveller","community"],
    question:"Should the government run all passenger trains under a single national organisation?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:211,status:"open",year:2026,
    title:"Better Buses Bill",category:"Transport",
    chamber:"House of Commons",date:"2025",
    desc:"Allowed local councils to franchise bus services and run municipal bus companies, reversing the 1980s deregulation of buses outside London.",
    impact:"Could affect all bus services outside London. Lets councils bring buses under local control.",
    plain:"Outside London, bus services were deregulated in the 1980s and run privately. This law lets councils take back control — franchising routes or even running their own bus companies. Manchester and other cities already used similar powers. Supporters say it will improve services; critics worry about cost.",
    lifeTags:["worker","elderly","community","young"],
    question:"Should local councils be allowed to run their own bus services?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:212,status:"closed",year:2025,
    title:"English Devolution Act 2025",category:"Constitution",
    chamber:"House of Commons",date:"Oct 2024",billId:3798,
    desc:"Created a framework for English devolution, allowing more areas to get elected mayors with greater powers over transport, housing, skills, and planning.",
    impact:"Up to 10 new mayoral combined authorities. Affects local governance across England.",
    plain:"More areas of England will be able to get elected mayors with real power over local decisions — things like transport, housing, job training and planning. Currently only a few cities like Manchester and London have this. The idea is to shift power away from Westminster to local communities.",
    lifeTags:["community","worker","homeowner"],
    question:"Should more of England have elected mayors with powers over local transport and housing?",
    outcome:"Devolution framework established. Several new mayoral areas began the process of getting powers in 2025.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:213,status:"closed",year:2025,
    title:"Product Safety and Metrology Act 2025",category:"Digital",
    chamber:"House of Commons",date:"Oct 2024",billId:3788,
    desc:"Updated product safety regulation for the post-Brexit UK, giving government powers to update rules quickly and bringing AI-enabled products into scope.",
    impact:"Affects all manufacturers and retailers selling products in the UK.",
    plain:"After leaving the EU, the UK needed its own product safety rules. This law gives the government the power to update safety standards quickly as technology changes — especially important for AI-powered products like smart home devices. Products sold in the UK must meet UK safety standards.",
    lifeTags:["family","business","community"],
    question:"Should the government have more power to quickly update safety rules for new technologies?",
    outcome:"Gained Royal Assent 2025. New product safety framework began replacing EU rules.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:214,status:"closed",year:2025,
    title:"Pension Schemes Act 2025",category:"Welfare",
    chamber:"House of Commons",date:"Nov 2024",billId:3816,
    desc:"Reformed private pensions — consolidated small pension pots, required schemes to offer retirement income products, and introduced a Value for Money framework.",
    impact:"Affects 10 million+ people with defined contribution pensions.",
    plain:"If you have a workplace pension, this law made changes to how it\'s managed. Small pension pots you might have from old jobs are being consolidated automatically so you don\'t lose track of them. Pension schemes now have to show they\'re giving people value for money — not just collecting fees.",
    lifeTags:["worker","elderly","family"],
    question:"Should pension schemes be legally required to prove they give workers value for money?",
    outcome:"Gained Royal Assent 2025. Automatic consolidation of small pension pots began.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:215,status:"closed",year:2025,
    title:"Arbitration Act 2025",category:"Justice",
    chamber:"House of Lords",date:"Nov 2024",billId:3695,
    desc:"Updated the law on arbitration in England and Wales, implementing recommendations from the Law Commission to modernise dispute resolution.",
    impact:"Improves England\'s competitiveness as a global arbitration centre.",
    plain:"Arbitration is when companies or individuals resolve disputes through a private referee rather than going to court. This updated the rules to make the UK\'s system more modern and competitive with other countries. Mostly affects businesses rather than individuals.",
    lifeTags:["business"],
    question:"Should arbitration law be updated to keep the UK competitive as a global legal centre?",
    outcome:"Gained Royal Assent 2025.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:216,status:"closed",year:2025,
    title:"Bank Resolution (Recapitalisation) Act 2025",category:"Finance",
    chamber:"House of Commons",date:"2025",
    desc:"Reformed how the Bank of England responds to failing banks — allowing it to use industry-funded resources to recapitalise failing institutions.",
    impact:"Strengthens the UK\'s toolkit for managing future banking crises.",
    plain:"If a bank is about to collapse, this law gives the Bank of England a new way to stabilise it using money from the banking industry rather than from taxpayers. It\'s designed to prevent a repeat of the 2008 financial crisis where the public had to bail out failing banks.",
    lifeTags:["worker","business","homeowner"],
    question:"Should the banking industry rather than taxpayers fund the rescue of failing banks?",
    outcome:"Gained Royal Assent 2025.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:217,status:"closed",year:2025,
    title:"Budget Responsibility Act 2025",category:"Finance",
    chamber:"House of Commons",date:"Aug 2024",billId:3710,
    desc:"Required the Office for Budget Responsibility to produce an assessment of any significant permanent tax or spending changes, introducing a \"fiscal lock\".",
    impact:"Prevents future governments from making major unfunded spending commitments without independent scrutiny.",
    plain:"After Liz Truss\'s 2022 mini-budget crashed the economy, this law stopped future governments from making huge tax and spending announcements without first getting the independent Office for Budget Responsibility to assess the impact. If you change the economy significantly, you have to show your working.",
    lifeTags:["worker","homeowner","business","family"],
    question:"Should governments be legally required to get independent economic assessments before major spending changes?",
    outcome:"Gained Royal Assent 2025. First used when the Autumn 2024 Budget was independently assessed.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:218,status:"closed",year:2025,
    title:"Lords (Removal of Hereditary Peers) Act 2025",category:"Constitution",
    chamber:"House of Lords",date:"Oct 2024",billId:3706,
    desc:"Removed the remaining 92 hereditary peers who had retained the right to sit and vote in the House of Lords under the 1999 compromise.",
    impact:"Ended 800 years of hereditary peers sitting in Parliament as of right.",
    plain:"For 800 years, people could sit in the House of Lords simply because they inherited a title from a parent or grandparent. This law removed the last 92 hereditary peers who still had that right. The Lords is now entirely made up of appointed life peers. Supporters called it long overdue. Critics said it was incomplete reform.",
    lifeTags:["community"],
    question:"Was it right to remove hereditary peers from the House of Lords?",
    outcome:"Gained Royal Assent January 2025. The last 92 hereditary peers left the Lords in February 2025.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:219,status:"closed",year:2025,
    title:"Crown Estate Act 2025",category:"Finance",
    chamber:"House of Commons",date:"Aug 2024",billId:3705,
    desc:"Gave the Crown Estate borrowing powers to invest in offshore wind and extended to Scotland and Northern Ireland.",
    impact:"Unlocks billions in investment for offshore wind energy by giving the Crown Estate commercial flexibility.",
    plain:"The Crown Estate owns vast amounts of UK seabed where offshore wind farms are built. This law lets it borrow money to invest in those wind farms, potentially generating billions in revenue that goes to the Treasury. It also extended the Crown Estate\'s remit to Scotland and Northern Ireland.",
    lifeTags:["homeowner","renter","worker","community"],
    question:"Should the Crown Estate have powers to borrow and invest in clean energy infrastructure?",
    outcome:"Gained Royal Assent 2025. Crown Estate announced major offshore wind investment plans.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:220,status:"closed",year:2025,
    title:"Water (Special Measures) Act 2025",category:"Environment",
    chamber:"House of Commons",date:"Oct 2024",billId:3760,
    desc:"Gave Ofwat stronger powers to hold water companies accountable — banned bonuses for executives at companies failing environmental standards, and enabled criminal prosecution of managers.",
    impact:"Affects all water companies in England and Wales after years of sewage dumping scandals.",
    plain:"Water companies had been dumping sewage into rivers and seas while paying executives millions in bonuses. This law banned those bonuses at companies failing environmental targets, and let regulators prosecute individual managers — not just fine the company. A first step before fuller water reform.",
    lifeTags:["family","community","health"],
    question:"Should water company executives lose their bonuses and face prosecution for sewage dumping?",
    outcome:"Gained Royal Assent 2025. Ofwat launched enforcement action against several water companies.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:221,status:"open",year:2026,
    title:"Water Industry Bill",category:"Environment",
    chamber:"House of Commons",date:"2026",
    desc:"Full reform of the water industry following the Special Measures Act — potentially including public ownership options and major regulatory overhaul.",
    impact:"Could fundamentally change how water is owned, regulated and managed in England and Wales.",
    plain:"After the Special Measures Act as a first step, this is the bigger water reform. It could change who owns and runs water companies, how they\'re regulated, and how they fund infrastructure. Whether to take water back into public ownership remains a live political debate.",
    lifeTags:["family","community","homeowner","renter"],
    question:"Should water companies be taken back into public ownership?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:222,status:"open",year:2026,
    title:"Assisted Dying Bill — Committee Stage",category:"Health",
    chamber:"House of Commons",date:"28 Jan 2026",billId:7060,
    desc:"The Assisted Dying Bill continues through Committee Stage where MPs are examining and amending the details of how assisted dying would work in practice.",
    impact:"Committee considering safeguards, eligibility, and the role of doctors and judges.",
    plain:"After MPs voted 330-275 for assisted dying in principle, the Bill is now being examined line by line. MPs are debating: how exactly do you prove someone has only 6 months to live? What if a doctor doesn\'t want to participate? How many judges need to approve? The details will determine whether the law works in practice.",
    lifeTags:["health","elderly","family"],
    question:"Are the safeguards in the Assisted Dying Bill strong enough to prevent abuse?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:223,status:"open",year:2026,
    title:"Public Office (Accountability) Bill",category:"Constitution",
    chamber:"House of Commons",date:"2026",
    desc:"Created new duties of candour for public officials and strengthened accountability for those in public office following the COVID-19 inquiry.",
    impact:"New legal duties for public officials to be honest. New powers to investigate failures.",
    plain:"Following the COVID inquiry revealing that officials withheld information and were not honest with the public, this law creates a legal duty for senior public officials to be candid and transparent. If they\'re not, they can face consequences. Supporters say it\'s overdue. Critics worry about chilling effects.",
    lifeTags:["community","worker"],
    question:"Should public officials face legal consequences for being dishonest with Parliament or the public?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:224,status:"closed",year:2025,
    title:"Finance Act 2025",category:"Finance",
    chamber:"House of Commons",date:"Oct 2024",billId:3873,
    desc:"The main Budget legislation — extended freeze on income tax thresholds, raised employers\' National Insurance contributions, changed inheritance tax rules on farms and pensions.",
    impact:"The largest tax-raising Budget since 1993. Raised £40bn in additional revenue.",
    plain:"This put the Autumn 2024 Budget into law. The key changes: employers\' National Insurance went up (meaning employment costs more, which some businesses passed on through lower pay or reduced hiring); income tax thresholds stayed frozen (so more of your pay gets taxed as wages rise); inheritance tax rules changed for farms and inherited pension pots.",
    lifeTags:["worker","homeowner","business","family","elderly"],
    question:"Was the government right to raise taxes significantly in the 2024 Budget?",
    moneyCalc:{label:"Employer NI impact on typical salary",fn:(p)=>p.worker?"Employers\' NI on a £30k salary rose by ~£900/year — impact varies by employer":"Affects self-employed and businesses differently"},
    outcome:"Finance Act gained Royal Assent March 2025. Employer NI rise came in April 2025.",
    significant:true,ayes:313,noes:262,abs:0,parlOutcome:"passed"}),

  makeBill({id:225,status:"closed",year:2025,
    title:"National Insurance Contributions (Secondary Class 1) Act 2025",category:"Finance",
    chamber:"House of Commons",date:"2025",
    desc:"Companion legislation to the Budget — formally legislated for the increase in employer National Insurance contributions announced in the Autumn 2024 Budget.",
    impact:"Raises £25bn — the single largest tax rise in the Budget.",
    plain:"This is the technical law behind the Budget\'s National Insurance rise for employers. When a business employs someone, it pays NI on their salary. This law raised that rate from 13.8% to 15% and lowered the threshold at which it kicks in. Many businesses said it raised their costs significantly.",
    lifeTags:["worker","business"],
    question:"Was raising employer National Insurance the right way to fund public services?",
    outcome:"Gained Royal Assent 2025. Came into effect April 2025.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:226,status:"closed",year:2025,
    title:"Crime (Aggravated Murder of Emergency Workers) Act 2025",category:"Justice",
    chamber:"House of Commons",date:"2025",
    desc:"Created a new offence of aggravated murder of an emergency worker, with a mandatory whole-life order where the victim was killed in the course of their duty.",
    impact:"Applies to murder of police, firefighters, paramedics and other emergency workers on duty.",
    plain:"If someone deliberately kills a police officer, firefighter or paramedic who is on duty, they now automatically get a whole-life sentence with no possibility of parole. Previously, judges had discretion. The law was introduced following the murders of police officers Nicola Hughes and Fiona Bone.",
    lifeTags:["community","worker"],
    question:"Should killing an emergency worker on duty automatically result in a whole-life sentence?",
    outcome:"Gained Royal Assent 2025.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:227,status:"closed",year:2025,
    title:"Border Security, Asylum and Immigration Act 2025",category:"Immigration",
    chamber:"House of Commons",date:"11 Dec 2024",billId:3860,
    desc:"Created a new Border Security Command, introduced new offences for people smugglers, established a Border Security Commissioner, and reformed the asylum system.",
    impact:"Major restructuring of border security and asylum. New criminal offences for smuggling gangs.",
    plain:"Labour\'s main immigration law. A new \"Border Security Command\" brings together police, intelligence and border force to target people smuggling gangs. New laws make it easier to prosecute the criminal networks behind dangerous Channel crossings. The asylum system is being reformed to process claims faster.",
    lifeTags:["community","worker"],
    question:"Should people smuggling gangs face tougher criminal penalties?",
    outcome:"Gained Royal Assent 2025. Border Security Commander appointed. Prosecutions of smuggling gangs increased.",
    significant:true,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),

  makeBill({id:228,status:"closed",year:2025,
    title:"Passenger Railway Services (Public Ownership) Act 2025",category:"Transport",
    chamber:"House of Commons",date:"15 Aug 2024",billId:3730,
    desc:"The immediate step to return rail to public ownership — gave ministers power to bring passenger rail contracts into public ownership as they expire or are terminated.",
    impact:"First step to public ownership. All train operating contracts eventually move to Great British Railways.",
    plain:"This was the quick first step to nationalise trains. Rather than waiting for the full Great British Railways legislation, this law let the government start taking over train companies straight away as their contracts ended. South Western Railway was one of the first to move into public ownership.",
    lifeTags:["worker","traveller","community"],
    question:"Should passenger railways be run by the government rather than private companies?",
    outcome:"First franchises transferred to public ownership in 2025. South Western Railway and others moved to GBR Operations Ltd.",
    significant:true,ayes:313,noes:234,abs:0,parlOutcome:"passed"}),

  makeBill({id:229,status:"open",year:2026,
    title:"Skills England Bill",category:"Education",
    chamber:"House of Commons",date:"2025",
    desc:"Created Skills England — a new national body to identify and address skills gaps, reform apprenticeships, and coordinate training with employers.",
    impact:"Overhaul of technical education and apprenticeships. New skills levy replacing old apprenticeship levy.",
    plain:"A new body — Skills England — will work with businesses, colleges and universities to identify what skills are actually needed and ensure training matches those needs. The old apprenticeship levy is being reformed so more of it can be spent on a wider range of training, not just formal apprenticeships.",
    lifeTags:["worker","young","family"],
    question:"Should the government take a more active role in directing workplace training and skills?",
    significant:true,ayes:0,noes:0,abs:0}),

  makeBill({id:230,status:"closed",year:2025,
    title:"Digital Information and Smart Data Act 2025",category:"Digital",
    chamber:"House of Lords",date:"Oct 2024",billId:3825,
    desc:"Enabled new uses of open banking and smart data across other sectors — giving consumers the right to share their data to get better deals on energy, broadband and financial products.",
    impact:"Extends Open Banking principles to energy, telecoms, insurance and other sectors.",
    plain:"Open Banking lets you share your bank data with apps to get better deals. This law extends that idea to energy bills, broadband, insurance and more. If you share your data with a comparison site, it can automatically find you the cheapest deal. You stay in control — companies can\'t use your data without permission.",
    lifeTags:["homeowner","renter","worker","family"],
    question:"Should consumers have the right to automatically share their data to get better deals on bills?",
    outcome:"Gained Royal Assent as the Data (Use and Access) Act 2025.",
    significant:false,ayes:0,noes:0,abs:0,parlOutcome:"passed"}),
];
    ...
    <div className="vote-card fade-up" style={{animationDelay:`${delay}s`, outline: isRelevant ? "2px solid var(--gold)" : "none", outlineOffset:"2px"}}>
      <div style={{display:"flex"}}>
        ...
        <div className="vote-body">
          ...
          <div className="vote-info" style={{display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
            <span>📅 {v.date}</span>
            {v.parlUrl && (
              <a href={v.parlUrl} target="_blank" rel="noopener noreferrer"
                style={{fontSize:".74rem",color:"var(--navy)",textDecoration:"none",display:"flex",alignItems:"center",gap:4,padding:"2px 8px",border:"1px solid rgba(13,27,42,.2)",borderRadius:2,background:"rgba(13,27,42,.04)",transition:".2s"}}
                onMouseOver={e=>{e.currentTarget.style.background="var(--navy)";e.currentTarget.style.color="var(--gold)"}}
                onMouseOut={e=>{e.currentTarget.style.background="rgba(13,27,42,.04)";e.currentTarget.style.color="var(--navy)"}}>
                🏛️ View on Parliament.uk ↗
              </a>
            )}
          </div>
